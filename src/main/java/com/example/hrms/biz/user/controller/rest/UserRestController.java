...
public class UserRestController {
    ...
    public Result createAccount(@RequestBody UserDTO.Req userReq) {
        ...
        Long departmentId = Long.valueOf(userService.getDepartmentIdByName(userReq.getDepartment_name()));
        if (departmentId == null) {
            return new Result("Invalid request", "Tên đơn vị không hợp lệ.");
        }

        // Cập nhật departmentId cho userReq
        userReq.setDepartmentId(departmentId);
