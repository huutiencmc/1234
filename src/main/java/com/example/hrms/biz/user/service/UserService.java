...
public class UserService {
    ...
    public void insertUser(User user) {
        // Lấy department_id từ department_name
        Integer departmentId = userMapper.getDepartmentIdByName(user.getDepartmentName());

        if (departmentId == null) {
            throw new RuntimeException("Department not found: " + user.getDepartmentName());
        }

        // Gán department_id vào user
    ...
    public Integer getDepartmentIdByName(String departmentName) {
        return userMapper.getDepartmentIdByName(departmentName);
    }
